...
**安装后的日常使用**请参见 [LawMind 律师快速指南](./LAWMIND-LAWYER-QUICKSTART.md)；完整功能与命令参考见归档手册 [LawMind 使用手册](./archive/LAWMIND-USER-MANUAL.md)（配置、Agent、案件、审核、运维命令与常见问题）。
...
| 数据处理说明       | [docs/archive/LAWMIND-DATA-PROCESSING.md](archive/LAWMIND-DATA-PROCESSING) |
...
- https://docs.lawmind.ai/archive/LAWMIND-DATA-PROCESSING
...
- 路径说明与目录布局见 [LawMind 私有化部署](./archive/LAWMIND-PRIVATE-DEPLOY.md)（归档）。
...
https://docs.lawmind.ai/archive/LAWMIND-SECURITY-CHECKLIST
