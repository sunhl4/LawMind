...
| `edition`                | Phase C: `solo`, `firm`, or `private_deploy` (labels / governance)     |
| `benchmarkGateMinScore`  | Phase C: minimum mean benchmark score (0–1) for CI or release gate     |
| `auditExportCadenceHint` | Phase C: suggested audit export cadence (e.g. ISO-8601 duration `P7D`) |
...
- [Phase C governance](/lawmind/phase-c-governance)
