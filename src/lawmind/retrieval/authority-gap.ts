...
export const DEMO_CORPUS_RISK_FLAG = "演示语料（非正式完整法库；正式引用请核对官方法条）";
...
export function authorityGapFromToolResult(result: { ok?: boolean; data?: unknown }): boolean {
...
export function demoCorpusFromToolResult(result: { ok?: boolean; data?: unknown }): boolean {
