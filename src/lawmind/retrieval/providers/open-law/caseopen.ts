...
import {
  assertOpenLawLiveEndpointSafe,
  validateOpenLawLiveEndpointUrl,
} from "./live-endpoint.js";
  ...
  try {
    ...
    if (contentType.includes("text/html") || /^\s*</.test(text)) {
      return {
        ...
        error: "caseopen_html_challenge:公网 demo 可能被 Cloudflare 拦截；请自建 cncases 并指向本机 /api/search",
      };
    }
