...
tools: explore_folder, import_host_file, update_matter_profile, extract_legal_events, apply_legal_events, compile_intake_brief, apply_intake_brief, add_case_note
---
...
1. 列文件，按委托、证据、对方文书、我方文稿、财务归类（`explore_folder` / `list_dir`）。
2. 抽出：当事人、案由/交易类型、关键日期、金额；需要归档用 `import_host_file`。
