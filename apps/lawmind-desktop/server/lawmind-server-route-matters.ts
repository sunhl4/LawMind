  ...
  if (pathname === "/api/matters/profile" && req.method === "POST") {
    ...
    try {
      ...
      const profile = buildMatterProfileView({
        ...
        causeOfAction: updated.causeOfAction ?? fromCase.causeOfAction,
        counterparty: updated.counterparty ?? fromCase.counterparty,
  ...
  if (pathname === "/api/matters/detail" && req.method === "GET") {
    ...
    const profile = record
      ? buildMatterProfileView({
          ...
          causeOfAction: record.causeOfAction ?? fromCase.causeOfAction,
          counterparty: record.counterparty ?? fromCase.counterparty,
