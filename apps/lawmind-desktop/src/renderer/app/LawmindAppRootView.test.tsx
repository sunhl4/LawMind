...
function minimalProps(overrides: Partial<LawmindAppRootViewProps> = {}): LawmindAppRootViewProps {
  ...
  const base = {
    ...
    sidebarProps: {
      ...
      delegations: [],
      collabEvents: [],
      collabTab: "delegations" as const,
      onSelectCollabTab: noop,
      filteredTasks: [],
      matterSidebarRows: [],
    ...
    headerProps: {
      ...
      onSetMainView: noop,
      onOpenCollaborationOverview: noop,
    ...
    mainBodyProps: {
      ...
      onRefreshCollaboration: noop,
      onOpenDelegationTargetChat: noop,
      collaborationDeskTab: "overview" as const,
    ...
    dialogProps: {
      ...
      matterRenameOpen: null,
      onCloseMatterRename: noop,
      onMatterRenameSuccess: noop,
      matterDeleteOpen: null,
      onCloseMatterDelete: noop,
      onMatterDeleteSuccess: noop,
      onMatterListChanged: noop,
      showActionHub: false,
      onCloseActionHub: noop,
      onRefreshActionSummary: noop,
      sessionRequiresActions: [],
      sessionId: null,
      onChatResumeComplete: noop,
      taskDrawerOpen: false,
      onCloseTaskDrawer: noop,
      toolApprovalDialogAction: null,
      loading: false,
      onCloseToolApproval: noop,
      onResumeRequiresAction: noop,
    },
  };
